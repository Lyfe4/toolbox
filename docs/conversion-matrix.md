...
**3 of 17** documented losses are told.
...
| 13  | `<caption>` dropped, Markdown target                     | Text convert · HTML → Markdown         | `text-convert`    | **lossy, silent** |
| 14  | A table cell's list structure flattened, Markdown target | Text convert · HTML → Markdown         | `text-convert`    | **lossy, silent** |
| 15  | An empty header row invented, Markdown target            | Text convert · HTML → Markdown         | `text-convert`    | **lossy, silent** |
