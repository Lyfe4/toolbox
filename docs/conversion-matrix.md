...
| A bold `<b>`, an italic `<i>`         | **corrected in round thirteen** | The census reported `<b>` as not carried and `<strong>` as invented on every document with a bold word, since round four on the normalised target. Four respellings - `b`/`strong`, `i`/`em`, `s`/`strike`/`del`, `tt`/`code` - are filtered, each checked against the HTML Standard's rendering section, and only when the counts balance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
